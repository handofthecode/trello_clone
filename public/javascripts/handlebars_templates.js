...
this["JST"]["list"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"board_item\">	<div class=\"list\" data-id=\""
    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
    + "\">		<form class=\"renameList\">			<input type=\"text\">			<input type=\"submit\">		</form>		<h1>"
    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
    + "</h1>		<div class=\"cards\">		</div>		<div class=\"new_card_form\">			<form>				<textarea></textarea>				<input type=\"submit\" value=\"Add\" class=\"save\">				<div class=\"cancel\">X</div>			</form>		</div>		<div class=\"card_form_toggle\">Add a card...</div>	</div></div>";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1;
